...
const struct items types_lookup[] = {
  type_lu_entry(no_type),
...
uint32_t parse_descriptions(hello_t *d)
{
  std::string file;
  std::ifstream f;
  uint32_t retval;
...
uint32_t print_descriptions(hello_t *d)
{
...
uint32_t destroy_descriptions(hello_t *d)
{
